...
import com.sbcloudoauth.oauthservice.entity.AuthClientDetails;
import com.sbcloudoauth.oauthservice.entity.Authorities;
import com.sbcloudoauth.oauthservice.entity.User;
...
public class InitialValuesChangeLog {
    ...
    @ChangeSet(order = "001", id = "insertBrowserClientDetails", author = "Maheshwar Ligade")
    ...
    @ChangeSet(order = "002", id = "insertUserToTestAuthentication", author = "Maheshwar Ligade")
